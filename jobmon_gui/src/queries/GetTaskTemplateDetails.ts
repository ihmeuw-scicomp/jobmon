...
export const getTaskTemplateDetailsQueryFn = async ({queryKey}: getTaskTemplateDetailsQueryFnArgs) => {
...
export const getTaskTemplateDetails = (workflowId: number | string, taskTemplateId: number | string) => {
    return useQuery({
