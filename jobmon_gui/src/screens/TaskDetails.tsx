      ...
      <JobmonModal
        ...
        children={
          <Grid container spacing={2}>
            ...
            <Grid item xs={9}>
              {' '}
              Task's dependencies have successfully completed, task can be run
            ...
            <Grid item xs={9}>
              {' '}
              A task instance is preparing to be launched/submitted.
            </Grid>
            <Grid item xs={3}>
              <b>Launched (L):</b>
            </Grid>
            ...
            <Grid item xs={9}>
              {' '}
              Task errored with a resource error, the resources will be adjusted
              before retrying.
            </Grid>
            <Grid item xs={3}>
              <b>Error Fatal (F):</b>
            ...
            <Grid item xs={9}>
              {' '}
              Task errored out and has used all of the attempts, therefore has
              failed for this WorkflowRun. <br />
            ...
            <Grid item xs={9}>
              {' '}
              Task ran successfully to completion; it has a TaskInstance that
