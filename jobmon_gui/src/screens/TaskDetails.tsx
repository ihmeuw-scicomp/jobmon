...
export default function TaskDetails() {
    ...
    if (task_details.isError) {
        return (
            <Typography>
                Unable to load task details. Please refresh and try again.
            </Typography>
        );
    }
        ...
        <div>
            ...
            <header className="div-level-2 header-1 ">
                ...
                <div className="row pt-2 mx-0 px-0">
                    <TaskDAG
                        taskId={taskId}
                        taskName={task_details?.data?.task_name}
            ...
            <JobmonModal
                ...
                children={
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={3}>
                            <b>Queued for Instantiation (Q):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            Task's dependencies have successfully completed,
                            task can be run when the scheduler is ready.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Instantiated (I):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            A task instance is preparing to be
                            launched/submitted.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Launched (L):</b>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            Task instance submitted to the cluster normally.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Running (R):</b>
                        </Grid>
                        ...
                        <Grid item xs={3}>
                            <b>Error Recoverable (E):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            Task has errored out but has more attempts so it
                            will be retried.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Adjusting Resources (A):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            Task errored with a resource error, the resources
                            will be adjusted before retrying.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Error Fatal (F):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            Task errored out and has used all of the attempts,
                            therefore has failed for this WorkflowRun. <br />
                            It can be resumed in a new WFR.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Done (D):</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            Task ran successfully to completion; it has a
                            TaskInstance that successfully completed.
                        </Grid>
                    </Grid>
                }
                open={showTaskFSM}
