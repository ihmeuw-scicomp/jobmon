...
const replacements = {
    "JOBMON_DB_HOST": process.env.DB_HOST,
    "JOBMON_DB_USER": process.env.DB_USER,
    "JOBMON_DB_PASSWORD": process.env.DB_PASSWORD,
    "JOBMON_DB_DATABASE": process.env.DB_DATABASE,
    "JOBMON_DB_PORT": process.env.DB_PORT,
}
