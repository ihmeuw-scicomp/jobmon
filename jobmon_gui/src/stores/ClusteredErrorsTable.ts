...
export const job_info_table_time_column_names = ['first_error_time'];
...
export type clusteredErrorsTableStore = {
  maxRows: number;
...
export const useClusteredErrorsTableStore = create<clusteredErrorsTableStore>()(
  persist(
    (set, get) => ({
      maxRows: 100,
