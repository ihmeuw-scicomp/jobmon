...
export default function WorkflowList() {
  ...
  if (workflows.isError) {
    return (
      <Typography>
        Error loading workflows. Please refresh and try again
      </Typography>
    );
  }
  ...
  if (workflows.data.length < 1) {
    return (
      <Typography>
        No workflows found for your current search. Please update your search
            ...
            <ListItem key={workflow.wf_id}>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <span
                    className={statusMap[workflow.wf_status].className}
                  ...
                  <ListItemText
                    primary={
                      <Typography variant="h6">
                        ...
                        >
                          {workflow.wf_id}{' '}
                          {workflow.wf_name ? `- ${workflow.wf_name}` : ''}
                        </Link>
                      </Typography>
                    }
                  />
                ...
                <JobmonProgressBar workflowId={workflow.wf_id} />
              </Box>
            </ListItem>
          ))}
        </List>
      ...
      <JobmonModal
        ...
        children={
          <Grid container spacing={2}>
            ...
            <Grid item xs={8}>
              <Typography sx={modalValuesStyles}>
            ...
            <Grid item xs={8}>
              <Typography sx={modalValuesStyles}>
                {dayjs(workflowDetails.wf_submitted_date)
                  .tz(
                    timezoneStore.get() ||
                      Intl.DateTimeFormat().resolvedOptions().timeZone
                  )
                  .format(timeFormatStore.get())}
              </Typography>
            </Grid>
            <Grid item xs={4}>
            ...
            <Grid item xs={8}>
              <Typography sx={modalValuesStyles}>
                {dayjs(workflowDetails.wf_status_date)
                  .tz(
                    timezoneStore.get() ||
                      Intl.DateTimeFormat().resolvedOptions().timeZone
                  )
