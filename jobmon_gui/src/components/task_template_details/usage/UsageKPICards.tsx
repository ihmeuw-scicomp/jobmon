      ...
      {isShowingSelection && (
        ...
        >
          ...
          <Typography variant="body2" fontWeight="medium">
            Showing statistics for <strong>{selectedDataCount}</strong> selected
            points (out of {totalDataCount} total)
          </Typography>
        </Box>
      )}
                ...
                <Grid item xs={4}>
                  ...
                  >
                    {kpiStats.minRuntime !== undefined
                      ? humanizeDuration(kpiStats.minRuntime * 1000, {
                          largest: 1,
                          round: true,
                        })
                      : 'N/A'}
                ...
                <Grid item xs={4}>
                  ...
                  >
                    {kpiStats.maxRuntime !== undefined
                      ? humanizeDuration(kpiStats.maxRuntime * 1000, {
                          largest: 1,
                          round: true,
                        })
                      : 'N/A'}
                ...
                <Grid item xs={4}>
                  ...
                  >
                    {kpiStats.medianRuntime !== undefined
                      ? humanizeDuration(kpiStats.medianRuntime * 1000, {
                          largest: 1,
                          round: true,
                        })
                      : 'N/A'}
                  ...
                  >
                    ...
                    <Box mb={1.5}>
                      ...
                      >
                        ...
                        >
                          {resourceEfficiency.runtimeUtilization.toFixed(1)}%
                          utilized
                        </Typography>
                    ...
                    <Box>
                      ...
                      <Typography
                        ...
                        sx={{ mt: 0.25 }}
                      >
                        {kpiStats.medianRequestedRuntime !== undefined
                          ? humanizeDuration(
                              kpiStats.medianRequestedRuntime * 1000,
                  ...
                  >
                    ...
                    <Box mb={1.5}>
                      ...
                      >
                        ...
                        >
                          {resourceEfficiency.memoryUtilization.toFixed(1)}%
                          utilized
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                    ...
                    <Box>
                      ...
                      <Typography
                        ...
                        sx={{ mt: 0.25 }}
                      >
                        {kpiStats.medianRequestedMemoryGiB !== undefined
