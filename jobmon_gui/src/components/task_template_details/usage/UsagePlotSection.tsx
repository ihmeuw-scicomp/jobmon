    ...
    >
      <Box sx={{ p: 3, pb: 1 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          Runtime vs memory usage patterns • Use toolbar: 🔍 to zoom/pan, 📦 for
          box select, 🎯 for lasso select •{' '}
          <strong>Statistics above update when you select data</strong> • Click
          points to view task details
        </Typography>
      </Box>
        ...
        {isLoading ? (
          ...
          >
            ...
            <Typography
              ...
              sx={{ maxWidth: 400 }}
            >
              No data matches the current filter criteria. Try adjusting your
              filters or check if data exists for this task template.
            </Typography>
          </Box>
        )}
      </Box>
