...
export default function ClusteredErrors({
    ...
    const prefetchErrorDetails = async (
        ...
        */
        await queryClient.prefetchQuery({
            ...
            queryFn: async () => {
                if (
                    nextErrorDetailIndex === false ||
                    nextErrorDetailIndex === true
                ) {
                    return;
                }
                const ti_id =
                    nextErrorDetailIndex.sample_ids[
                        nextErrorDetailIndex.sample_index
                    ];
                return axios
                    .get(
    ...
    if (errors.isError) {
        return (
            <Typography>
                Unable to retrieve clustered errors. Please refresh and try
                again
            </Typography>
        );
    }
