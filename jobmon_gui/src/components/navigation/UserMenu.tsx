    ...
    return (
        <>
            ...
            >
                ...
                <MenuItem id="menu-item-logout" onClick={() => setSettingsOpen(true)}>
                    <TuneIcon/> Settings
                </MenuItem>
            ...
            <JobmonModal title={"Settings"} open={settingsOpen} onClose={() => setSettingsOpen(false)} width={'80%'}>
                <Grid container spacing={4} sx={{pl: 4}}>
                    ...
                    <Grid item xs={9}>
                        <Select value={timezoneStore.get()} onChange={(e) => timezoneStore.set(e.target.value)}>
                            <MenuItem
                                value={timezoneStore.getBrowserDefaultTimezone()}>{timezoneStore.getBrowserDefaultTimezone()}</MenuItem>
                    ...
                    <Grid item xs={4}>
                        <Select value={timeFormatStore.get()} onChange={(e) => timeFormatStore.set(e.target.value)}>
                    ...
                    <Grid item xs={5}>
                        <Button
                            sx={{mt: 1}}
                            variant={"outlined"}
                            onClick={() => window.open("https://day.js.org/docs/en/display/format", '_blank').focus()}>
