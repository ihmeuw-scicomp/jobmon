...
export default function TaskInstanceTable({ taskId }: TaskInstanceTableProps) {
  ...
  if (ti_details.isError) {
    ...
    return (
      <Typography>
        Error loading task instance table. Please reload and try again
      </Typography>
    );
  }
    ...
    <div>
      ...
      <JobmonModal
        ...
        children={
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <ScrollableCodeBlock>{rowDetail.ti_stdout}</ScrollableCodeBlock>{' '}
              <br></br>
            </Grid>
            <Grid item xs={12}>
      ...
      <JobmonModal
        ...
        children={
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography variant={'h6'}>Standard Error Path:</Typography>
            </Grid>
            <Grid item xs={12}>
              <ScrollableCodeBlock>{rowDetail.ti_stderr}</ScrollableCodeBlock>
            </Grid>
            <Grid item xs={12}>
              <Typography variant={'h6'}>Standard Error Log:</Typography>
            </Grid>
            <Grid item xs={12}>
              <ScrollableCodeBlock>
        ...
        children={
          <p>
            ...
            {rowDetail.ti_wallclock
              ? humanizeDuration(
                  parseInt(rowDetail.ti_wallclock.toString()) * 1000
                )
              : ''}
          </p>
        }
      ...
      <JobmonModal
        ...
        children={
          <Grid container spacing={2}>
            <Grid item xs={3}>
              <b>Submitted to Batch Distributor:</b>
            </Grid>
            <Grid item xs={9}>
              {' '}
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance stopped with an application error (non-zero return
              code).
            </Grid>
            <Grid item xs={3}>
              <b>Error Fatal:</b>
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance killed itself as part of a cold workflow resume, and
              cannot be retried.
            </Grid>
            <Grid item xs={3}>
              <b>Instantiated:</b>
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance is created within Jobmon, but not queued for
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance has been ordered to kill itself if it is still alive,
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance submitted to the cluster normally, part of a Job
              Array.
            </Grid>
            <Grid item xs={3}>
              <b>Queued:</b>
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance has errored, Jobmon is determining the category of
              error.
            </Grid>
            <Grid item xs={3}>
              <b>Unknown Error:</b>
            ...
            <Grid item xs={9}>
              {' '}
              TaskInstance stopped reporting that it was alive for an unknown
              reason.
            </Grid>
            <Grid item xs={3}>
              <b>No Distributor ID:</b>
            </Grid>
            <Grid item xs={9}>
              {' '}
              TaskInstance submission within Jobmon failed – did not receive a
              job number from the cluster.
            </Grid>
            <Grid item xs={3}>
              <b>Resource Error:</b>
            </Grid>
            <Grid item xs={9}>
              {' '}
              TaskInstance died because of insufficient resource request, i.e.
              insufficient memory or runtime.
            </Grid>
          </Grid>
        }
