                    ...
                    <p>
                        ...
                        {rowDetail.ti_resources && (
                            <>
                                ...
                                >
                                    {Object.keys(
                                        JSON.parse(rowDetail.ti_resources)
                                    ).map(key => {
            ...
            <JobmonModal
                ...
                children={
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance stopped with an application error
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance killed itself as part of a cold
                            workflow resume, and cannot be retried.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Instantiated:</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance is created within Jobmon, but not
                            queued for submission to the cluster.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Kill Self:</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance has been ordered to kill itself if it
                            is still alive, as part of a cold workflow resume.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Launched:</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance submitted to the cluster normally, part
                            of a Job Array.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Queued:</b>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance is queued for submission to the
                            cluster.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Running:</b>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance has errored, Jobmon is determining the
                            category of error.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Unknown Error:</b>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance stopped reporting that it was alive for
                            an unknown reason.
                        </Grid>
                        <Grid item xs={3}>
                        ...
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance submission within Jobmon failed – did
                            not receive a job number from the cluster.
                        </Grid>
                        <Grid item xs={3}>
                            <b>Resource Error:</b>
                        </Grid>
                        <Grid item xs={9}>
                            {' '}
                            TaskInstance died because of insufficient resource
                            request, i.e. insufficient memory or runtime.
                        </Grid>
                    </Grid>
                }
