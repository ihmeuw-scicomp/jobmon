...
export default function TaskDAG({
  ...
  if (taskDependencies.isError) {
    return (
      <Typography>
        Error loading upstream and downstream tasks. Please reload and try
        again.
      </Typography>
    );
  }
        ...
        children={
          <Grid container spacing={2}>
            ...
            <Grid item xs={9}>
              ...
              <IconButton
                onClick={() => setUpdateTaskCollepsOpen(prev => !prev)}
              >
            ...
            <Grid item xs={9}>
              {formatJobmonDate(task_details?.data?.task_status_date)}
            </Grid>
          </Grid>
        }
        open={showTaskInfo}
