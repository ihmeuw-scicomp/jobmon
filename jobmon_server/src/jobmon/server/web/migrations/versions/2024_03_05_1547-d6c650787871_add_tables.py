...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_task_template_version_task_template_id",
        "task_template_version",
        ["task_template_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_cluster_cluster_type_id", "cluster", ["cluster_type_id"], unique=False
    )
    op.create_table(
        "template_arg_map",
    ...
    op.create_index(
        "ix_template_arg_map_arg_id", "template_arg_map", ["arg_id"], unique=False
    )
    op.create_index(
        "ix_template_arg_map_arg_type_id",
        "template_arg_map",
        ["arg_type_id"],
        unique=False,
    )
    op.create_index(
        "ix_template_arg_map_task_template_version_id",
        "template_arg_map",
        ["task_template_version_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_tool_version_tool_id", "tool_version", ["tool_id"], unique=False
    )
    op.create_table(
        "queue",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_task_template_tool_version_id",
        "task_template",
        ["tool_version_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_workflow_tool_version_id", "workflow", ["tool_version_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_task_resources_queue_id", "task_resources", ["queue_id"], unique=False
    )
    op.create_index(
        "ix_task_resources_task_resources_type_id",
        "task_resources",
    ...
    op.create_index(
        "ix_workflow_attribute_workflow_attribute_type_id",
        "workflow_attribute",
        ["workflow_attribute_type_id"],
        unique=False,
    )
    op.create_index(
        "ix_workflow_attribute_workflow_id",
        "workflow_attribute",
        ["workflow_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_workflow_run_workflow_id", "workflow_run", ["workflow_id"], unique=False
    )
    op.create_table(
        "task",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_task_task_resources_id", "task", ["task_resources_id"], unique=False
    )
    ...
    op.create_index(
        "ix_task_attribute_task_attribute_type_id",
        "task_attribute",
        ["task_attribute_type_id"],
        unique=False,
    )
    op.create_index(
        "ix_task_attribute_task_id", "task_attribute", ["task_id"], unique=False
    )
    op.create_table(
        "task_instance",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_task_instance_array_id", "task_instance", ["array_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_task_instance_status", "task_instance", ["status"], unique=False
    )
    op.create_index(
        "ix_task_instance_task_id", "task_instance", ["task_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_task_instance_workflow_run_id",
        "task_instance",
        ["workflow_run_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_task_instance_error_log_task_instance_id",
        "task_instance_error_log",
        ["task_instance_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_task_attribute_task_attribute_type_id", table_name="task_attribute"
    )
    ...
    op.drop_index(
        "ix_task_resources_task_resources_type_id", table_name="task_resources"
    )
    ...
    op.drop_index(
        "ix_template_arg_map_task_template_version_id", table_name="template_arg_map"
    )
    ...
    op.drop_index(
        "ix_task_template_version_task_template_id", table_name="task_template_version"
    )
