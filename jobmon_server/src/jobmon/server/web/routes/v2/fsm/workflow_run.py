...
@api_v1_router.put("/workflow_run/{workflow_run_id}/terminate_task_instances")
@api_v2_router.put("/workflow_run/{workflow_run_id}/terminate_task_instances")
...
@api_v1_router.post("/workflow_run/{workflow_run_id}/log_heartbeat")
@api_v2_router.post("/workflow_run/{workflow_run_id}/log_heartbeat")
...
@api_v1_router.put("/workflow_run/{workflow_run_id}/update_status")
@api_v2_router.put("/workflow_run/{workflow_run_id}/update_status")
...
@api_v1_router.post("/workflow_run/{workflow_run_id}/sync_status")
@api_v2_router.post("/workflow_run/{workflow_run_id}/sync_status")
...
@api_v2_router.post("/workflow_run/{workflow_run_id}/set_status_for_triaging")
